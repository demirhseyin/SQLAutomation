...
DECLARE @FullBPath VARCHAR(256) ='C:\Logs' --Full Backup Directory
DECLARE @BackupName nvarchar(50)='DB_FULL.bak' --Full Backup Name
DECLARE @DB nvarchar(10) = 'demirtest' --Database Name
...
DECLARE @LogBPath nvarchar(50)='C:\Logs' --Log Backup Directory 
DECLARE @backupFile NVARCHAR(500) --Log Backup Name
DECLARE @DB nvarchar(10) = 'demirtest' --Database Name(Duplicate)
